...
def main() -> int:
    ...
    legacy = SourceDocument(source_id="legacy", title="Legacy", content="content")
    ...
    checks = {
        ...
        "uppercase_type_normalized": normalized.source_type == "article-notes",
        "legacy_defaults_preserved": legacy.source_type == "text" and legacy.origin == "fixture",
