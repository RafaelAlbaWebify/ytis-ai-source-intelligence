...
def main() -> int:
    ...
    reports = {template: render_reviewed_report(investigation, template) for template in REPORT_TEMPLATES}
    paths = {template: write_reviewed_report(investigation, template, OUT / "files") for template in REPORT_TEMPLATES}
