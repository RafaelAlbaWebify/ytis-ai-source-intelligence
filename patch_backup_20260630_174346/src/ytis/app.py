...
SOURCE_PLACEHOLDER = 'data:image/svg+xml;utf8,%0A%3Csvg%20xmlns%3D%27http%3A//www.w3.org/2000/svg%27%20width%3D%27900%27%20height%3D%27520%27%20viewBox%3D%270%200%20900%20520%27%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%27g%27%20x1%3D%270%27%20y1%3D%270%27%20x2%3D%271%27%20y2%3D%271%27%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%270%25%27%20stop-color%3D%27%230f172a%27/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%27100%25%27%20stop-color%3D%27%23111827%27/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%27900%27%20height%3D%27520%27%20rx%3D%2728%27%20fill%3D%27url%28%23g%29%27/%3E%0A%20%20%3Crect%20x%3D%2740%27%20y%3D%2740%27%20width%3D%27820%27%20height%3D%27120%27%20rx%3D%2718%27%20fill%3D%27%231f2937%27%20opacity%3D%270.9%27/%3E%0A%20%20%3Ccircle%20cx%3D%27110%27%20cy%3D%27100%27%20r%3D%2736%27%20fill%3D%27%23ef4444%27/%3E%0A%20%20%3Cpolygon%20points%3D%27100%2C82%20100%2C118%20129%2C100%27%20fill%3D%27white%27/%3E%0A%20%20%3Ctext%20x%3D%27170%27%20y%3D%2790%27%20fill%3D%27white%27%20font-size%3D%2734%27%20font-family%3D%27Arial%2C%20Helvetica%2C%20sans-serif%27%20font-weight%3D%27700%27%3ESource%20Preview%3C/text%3E%0A%20%20%3Ctext%20x%3D%27170%27%20y%3D%27126%27%20fill%3D%27%2394a3b8%27%20font-size%3D%2720%27%20font-family%3D%27Arial%2C%20Helvetica%2C%20sans-serif%27%3EChannel%20screenshot%20/%20video%20thumbnail%20area%3C/text%3E%0A%20%20%3Crect%20x%3D%2740%27%20y%3D%27190%27%20width%3D%27500%27%20height%3D%27270%27%20rx%3D%2718%27%20fill%3D%27%230b1220%27%20stroke%3D%27%23334155%27/%3E%0A%20%20%3Crect%20x%3D%27570%27%20y%3D%27190%27%20width%3D%27290%27%20height%3D%27270%27%20rx%3D%2718%27%20fill%3D%27%230b1220%27%20stroke%3D%27%23334155%27/%3E%0A%20%20%3Ctext%20x%3D%2785%27%20y%3D%27330%27%20fill%3D%27%2360a5fa%27%20font-size%3D%2726%27%20font-family%3D%27Arial%2C%20Helvetica%2C%20sans-serif%27%3EPreview%20panel%20ready%20for%20source%20screenshot%20integration%3C/text%3E%0A%20%20%3Ctext%20x%3D%2785%27%20y%3D%27366%27%20fill%3D%27%2394a3b8%27%20font-size%3D%2718%27%20font-family%3D%27Arial%2C%20Helvetica%2C%20sans-serif%27%3EWhen%20the%20URL%20is%20a%20video%2C%20show%20thumbnail.%20When%20it%20is%20a%20channel%2C%20show%20one%20channel%20screenshot.%3C/text%3E%0A%20%20%3Ctext%20x%3D%27608%27%20y%3D%27248%27%20fill%3D%27white%27%20font-size%3D%2724%27%20font-family%3D%27Arial%2C%20Helvetica%2C%20sans-serif%27%20font-weight%3D%27700%27%3EPreview%20Metadata%3C/text%3E%0A%20%20%3Ctext%20x%3D%27608%27%20y%3D%27292%27%20fill%3D%27%2394a3b8%27%20font-size%3D%2718%27%20font-family%3D%27Arial%2C%20Helvetica%2C%20sans-serif%27%3EType%3A%20Channel%20/%20Video%3C/text%3E%0A%20%20%3Ctext%20x%3D%27608%27%20y%3D%27324%27%20fill%3D%27%2394a3b8%27%20font-size%3D%2718%27%20font-family%3D%27Arial%2C%20Helvetica%2C%20sans-serif%27%3ETitle%20/%20Handle%3C/text%3E%0A%20%20%3Ctext%20x%3D%27608%27%20y%3D%27356%27%20fill%3D%27%2394a3b8%27%20font-size%3D%2718%27%20font-family%3D%27Arial%2C%20Helvetica%2C%20sans-serif%27%3EURL%3C/text%3E%0A%20%20%3Ctext%20x%3D%27608%27%20y%3D%27388%27%20fill%3D%27%2394a3b8%27%20font-size%3D%2718%27%20font-family%3D%27Arial%2C%20Helvetica%2C%20sans-serif%27%3EStatus%3C/text%3E%0A%3C/svg%3E%0A'
...
def get_source_meta(url: str, project_name: str) -> dict[str, str]:
    ...
    if video_id:
        ...
        return {
            ...
            "status": "Thumbnail preview loaded from YouTube static thumbnail.",
            "url": url or "-",
        }
    ...
    return {
        ...
        "status": "Channel preview area ready. Real channel screenshot can be integrated next.",
        "url": url or "-",
    }
...
def dashboard() -> None:
    ...
    with ui.row().classes("w-full text-white ytis-shell"):
        ...
        with ui.column().classes("ytis-main p-8 gap-5 flex-1"):
            with ui.row().classes("ytis-topbar w-full"):
                with ui.column().classes("gap-0"):
                    ui.label("Dashboard").classes("text-4xl font-bold")
            ...
            with ui.row().classes("w-full gap-4 items-stretch"):
                with ui.card().classes("ytis-card p-5 gap-3").style("flex: 1.3; min-width: 420px;"):
                    ui.label("Build Research Pack").classes("text-2xl font-bold")
                    ...
                    with ui.row().classes("w-full gap-3"):
                        ...
                        browse_button = ui.button("Browse", icon="folder_open").props("outline")

                    mode = ui.select(["reuse", "refresh", "repackage"], value="reuse", label="Build mode").classes("w-full")
                    ui.label("reuse = use existing subtitles if available (fastest)  •  refresh = contact YouTube again  •  repackage = build ZIP only from existing files").classes("text-xs text-slate-400")
                ...
                with ui.card().classes("ytis-card p-5 gap-2").style("flex: 1.05; min-width: 330px;"):
                    with ui.row().classes("w-full justify-between items-center"):
                        ui.label("Process Log").classes("text-2xl font-bold")
                        process_status = ui.label("Waiting").classes("text-sm text-green-500")
                    process_log = ui.log(max_lines=300).classes("w-full").style("height: 520px;")

                with ui.card().classes("ytis-card p-5 gap-3").style("flex: 0.95; min-width: 320px;"):
                    with ui.row().classes("w-full justify-between items-center"):
                        ui.label("Source Preview").classes("text-2xl font-bold")
                        source_type = ui.label("Channel").classes("text-xs text-red-400")
                    source_image = ui.image(SOURCE_PLACEHOLDER).classes("w-full rounded-xl").style("height: 180px; object-fit: cover;")
                    source_title = ui.label("No source selected").classes("text-xl font-bold")
            ...
            with ui.row().classes("w-full gap-4"):
                ...
                for title, key, default in metric_defs:
                    with ui.card().classes("ytis-metric p-4").style("flex: 1; min-width: 180px;"):
                        ui.label(title).classes("text-sm text-slate-400")
                        metric_labels[key] = ui.label(default).classes("text-4xl font-bold")

            with ui.row().classes("w-full gap-4 items-stretch"):
                with ui.card().classes("ytis-card p-5 gap-3").style("flex: 1.2; min-width: 360px;"):
                    ui.label("Last Build Summary").classes("text-2xl font-bold")
                    with ui.grid(columns=2).classes("w-full gap-3"):
                        for key, title in [
                            ...
                            ("transcripts", "Transcripts (Subtitles)"),
                            ("zip", "ZIP Path"),
                            ("words", "Total Words"),
                            ...
                            with ui.column().classes("gap-1"):
                                ...
                                last_summary_labels[key] = ui.label("-").classes("text-sm text-slate-200 break-all")

                with ui.card().classes("ytis-card p-5 gap-3").style("flex: 0.8; min-width: 300px;"):
                    with ui.row().classes("w-full justify-between items-center"):
                        ui.label("Health Check").classes("text-2xl font-bold")
                        ui.label("All Systems OK").classes("text-sm text-green-500")
                    for label, value in [
                ...
                with ui.card().classes("ytis-card p-5 gap-3").style("flex: 1.2; min-width: 360px;"):
                    with ui.row().classes("w-full justify-between items-center"):
                        ui.label("Recent Projects").classes("text-2xl font-bold")
                    ...
                    if not project_summaries:
                        ...
                        for project in project_summaries[:4]:
                            with ui.card().classes("ytis-metric p-3 w-full"):
                                ...
                                with ui.row().classes("gap-2 wrap mt-2"):
                                    ui.button("Load", icon="bolt", on_click=lambda p=project: load_project(p)).props("outline dense")
                                    if project.get('project_dir'):
                                        ui.button("Open Folder", icon="folder_open", on_click=lambda p=project: open_path(str(p.get('project_dir')))).props("outline dense")
                                    if project.get('zip_path'):
                                        ui.button("Open ZIP", icon="inventory_2", on_click=lambda p=project: open_path(str(p.get('zip_path')))).props("outline dense")
