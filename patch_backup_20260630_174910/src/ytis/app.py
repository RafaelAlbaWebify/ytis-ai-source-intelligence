...
SOURCE_PLACEHOLDER = "data:image/svg+xml;utf8,%0A%3Csvg%20xmlns%3D%27http%3A//www.w3.org/2000/svg%27%20width%3D%27900%27%20height%3D%27520%27%20viewBox%3D%270%200%20900%20520%27%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%27bg%27%20x1%3D%270%27%20y1%3D%270%27%20x2%3D%271%27%20y2%3D%271%27%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%270%25%27%20stop-color%3D%27%23050b16%27/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%27100%25%27%20stop-color%3D%27%2314233a%27/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%20%20%3ClinearGradient%20id%3D%27red%27%20x1%3D%270%27%20y1%3D%270%27%20x2%3D%271%27%20y2%3D%270%27%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%270%25%27%20stop-color%3D%27%23111827%27/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%27100%25%27%20stop-color%3D%27%237f1d1d%27/%3E%0A%20%20%20%20%3C/linearGradient%3E%0A%20%20%3C/defs%3E%0A%20%20%3Crect%20width%3D%27900%27%20height%3D%27520%27%20rx%3D%2724%27%20fill%3D%27url%28%23bg%29%27/%3E%0A%20%20%3Crect%20x%3D%2732%27%20y%3D%2732%27%20width%3D%27836%27%20height%3D%27130%27%20rx%3D%2718%27%20fill%3D%27url%28%23red%29%27/%3E%0A%20%20%3Ctext%20x%3D%2770%27%20y%3D%2792%27%20fill%3D%27white%27%20font-size%3D%2734%27%20font-family%3D%27Arial%27%20font-weight%3D%27700%27%3EYouTube%20Channel%20Preview%3C/text%3E%0A%20%20%3Ctext%20x%3D%2770%27%20y%3D%27128%27%20fill%3D%27%23cbd5e1%27%20font-size%3D%2718%27%20font-family%3D%27Arial%27%3EA%20single%20source%20screenshot%20will%20appear%20here%3C/text%3E%0A%20%20%3Ccircle%20cx%3D%27120%27%20cy%3D%27240%27%20r%3D%2756%27%20fill%3D%27%23ef4444%27/%3E%0A%20%20%3Cpolygon%20points%3D%27105%2C210%20105%2C270%20155%2C240%27%20fill%3D%27white%27/%3E%0A%20%20%3Ctext%20x%3D%27205%27%20y%3D%27230%27%20fill%3D%27white%27%20font-size%3D%2730%27%20font-family%3D%27Arial%27%20font-weight%3D%27700%27%3EChannel%20/%20Video%20Snapshot%3C/text%3E%0A%20%20%3Ctext%20x%3D%27205%27%20y%3D%27268%27%20fill%3D%27%2394a3b8%27%20font-size%3D%2720%27%20font-family%3D%27Arial%27%3EOne%20visual%20preview%20only%3A%20channel%20when%20URL%20is%20a%20channel%2C%20video%20thumbnail%20when%20URL%20is%20a%20video.%3C/text%3E%0A%20%20%3Crect%20x%3D%2770%27%20y%3D%27335%27%20width%3D%27170%27%20height%3D%2780%27%20rx%3D%2712%27%20fill%3D%27%230f172a%27%20stroke%3D%27%23334155%27/%3E%0A%20%20%3Crect%20x%3D%27270%27%20y%3D%27335%27%20width%3D%27170%27%20height%3D%2780%27%20rx%3D%2712%27%20fill%3D%27%230f172a%27%20stroke%3D%27%23334155%27/%3E%0A%20%20%3Crect%20x%3D%27470%27%20y%3D%27335%27%20width%3D%27170%27%20height%3D%2780%27%20rx%3D%2712%27%20fill%3D%27%230f172a%27%20stroke%3D%27%23334155%27/%3E%0A%20%20%3Crect%20x%3D%27670%27%20y%3D%27335%27%20width%3D%27130%27%20height%3D%2780%27%20rx%3D%2712%27%20fill%3D%27%230f172a%27%20stroke%3D%27%23334155%27/%3E%0A%3C/svg%3E%0A"
...
def dashboard() -> None:
    ...
    .ytis-main { min-height: 100vh; max-width: 1620px; }
    .ytis-card {
    ...
    with ui.row().classes("w-full text-white ytis-shell"):
        ...
        with ui.column().classes("ytis-main p-7 gap-4 flex-1"):
            ...
            with ui.row().classes("w-full gap-4 items-stretch"):
                with ui.card().classes("ytis-card p-4 gap-2").style("flex: 1.23; min-width: 420px;"):
                ...
                with ui.card().classes("ytis-card p-4 gap-2").style("flex: 1.08; min-width: 360px;"):
                    with ui.row().classes("w-full justify-between items-center"):
                        ui.label("Process Log").classes("text-2xl font-bold")
                        process_status = ui.label("Waiting").classes("text-sm text-green-500")
                    process_log = ui.log(max_lines=300).classes("w-full ytis-process-log").style("height: 385px;")

                with ui.card().classes("ytis-card p-4 gap-2").style("flex: 0.95; min-width: 330px;"):
                    with ui.row().classes("w-full justify-between items-center"):
                    ...
                    source_title = ui.label("No source selected").classes("text-lg font-bold")
            ...
            with ui.row().classes("w-full gap-3"):
                ...
                for title, key, default in metric_defs:
                    with ui.card().classes("ytis-metric p-3").style("flex: 1; min-width: 170px;"):
                        ui.label(title).classes("text-sm text-slate-400")
                        metric_labels[key] = ui.label(default).classes("text-3xl font-bold")

            with ui.row().classes("w-full gap-4 items-stretch"):
                with ui.card().classes("ytis-card p-4 gap-2").style("flex: 1.15; min-width: 360px;"):
                ...
                with ui.card().classes("ytis-card p-4 gap-2").style("flex: 0.85; min-width: 300px;"):
                    with ui.row().classes("w-full justify-between items-center"):
                ...
                with ui.card().classes("ytis-card p-4 gap-2").style("flex: 1.2; min-width: 360px;"):
                    with ui.row().classes("w-full justify-between items-center"):
