    ...
    if template == "source-credibility":
        ...
        body = [
            ...
            *_finding_lines(accepted, categories={"capability", "constraint", "recommendation"}),
            "## Risks", "", *_finding_lines(accepted, categories={"risk"}),
        ]
        ...
        body = [
            "## Opportunity signals", "", *_finding_lines(accepted, categories={"capability", "recommendation"}),
            "## Constraints and risks", "", *_finding_lines(accepted, categories={"constraint", "risk"}),
            "## Category balance", "",
...
def write_reviewed_report(investigation: Investigation, template: str, output_dir: Path) -> Path:
